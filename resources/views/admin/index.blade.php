        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="#">User account management</a>
                    <a class="collapse-item" href="#">Payment plans</a>
                    <a class="collapse-item" href="#">Email users</a>
                    <div class="collapse-divider"></div>
                    <h6 class="collapse-header">Other Pages:</h6>
                    <a class="collapse-item" href="404.html">Page 1</a>
                    <a class="collapse-item" href="blank.html">Page 2</a>
                </div>
            </div>
        </li>
...
<a href="{{ url('payment') }}" class="btn-danger" style="width: 100px; height: 50px; text-align: center; padding-top: 20px; font-size: 10px">Send mail</a>
...
{{--                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="public/admin-panel-css/img/undraw_posting_photo.svg" alt="">--}}
{{--                                </div>--}}
...
<!-- Page level plugins -->
{{--<script src="{{asset('admin-panel-css/vendor/chart.js/Chart.min.js')}}"></script>--}}

<!-- Page level custom scripts -->
{{--<script src="{{asset('admin-panel-css/js/demo/chart-area-demo.js')}}"></script>--}}
{{--<script src="{{asset('admin-panel-css/js/demo/chart-pie-demo.js')}}"></script>--}}
